...
# execution order:
version 1:
A simple chat bot with a good personality, and ability to check weather and other stuff

Version 2:
Give it a Voice

Version 3:
Creating and noting down in files, locate and move files
no access to alter any files

Version 4:
Move and manage GUI windows, open and close apps

Version 5:
Build the robot

Version 6:
Integrate with the robot